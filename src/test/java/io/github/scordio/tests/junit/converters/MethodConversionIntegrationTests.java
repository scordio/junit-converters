...
class MethodConversionIntegrationTests {
	...
	static class ParameterUseCasesTestCase {
		...
		@Nested
		class With_Method_Matching_Source_And_Target_Types {
		...
		@Nested
		class With_Method_Accepting_Source_Type_Primitive {
		...
		@Nested
		class With_Method_Accepting_Source_Type_Supertype {
		...
		@Nested
		class With_Method_Producing_Target_Type_Subtype {
